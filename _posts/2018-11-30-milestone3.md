...
We then use the L, B, and R variables to have our robot go in the direction of the neighbor it hasn't visited, or by default prioritize going forwards, or left (second priority), or right (third priority), or turn completely around 180 degrees (last priority).
