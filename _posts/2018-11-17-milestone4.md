...
Once we had the values for each section, we used these sections to tell what shape it is. The black dots in this image represent the locations that we took 
