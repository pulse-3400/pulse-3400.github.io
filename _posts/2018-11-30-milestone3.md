...
We began by writing a [DFS algorithm in Java](https://github.com/pulse-3400/labs/blob/master/milestone3/Maze.java), since the language is similar to C++ and allows for easy implementation of various data structures. 
