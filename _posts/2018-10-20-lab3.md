...
The Arduino has a limited number of analog input pins, so integrating all of the features together (three line sensors, three wall sensors, and two amplifiers for 660 Hz listening and IR sensing) required adding an analog multiplexer. In our code, we added a global MUXPIN variable that switched between the signal amp pins (when high) and wall sensor pins (when low).
...
<p align="center">
  <img src="/images/lab3_wallfollowing.png" width="630px" height="394px"/><br/>
</p>


**A video of our robot completing the backwards-S maze and properly updating the GUI can be found [here](https://www.youtube.com/watch?v=A6izcRQZ11k).**
...
<p align="center">
  <img src="/images/lab3_robot.JPG" width="600px" height="394px"/><br/>
</p>

**See the complete integration of all subparts and our robot completing all required tasks for this lab [here](https://www.youtube.com/watch?v=irVcJbTcGAA). See the latest code our robot is running [here](https://github.com/pulse-3400/labs/blob/master/lab3/lab3_2.ino).**
