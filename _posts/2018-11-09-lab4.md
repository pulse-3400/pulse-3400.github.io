...
We then debugged our image processing code. To tell if our image processor was working correctly, we output "RED", "BLUE", or "NO COLOR" to the serial monitor. **[Here is a video of the image processor](https://www.youtube.com/watch?v=XkMZc-6ARys)**
